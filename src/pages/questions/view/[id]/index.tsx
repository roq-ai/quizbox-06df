...
import { deleteOptionById } from 'apiSdk/options';
...
function QuestionViewPage() {
  ...
  const optionHandleDelete = async (id: string) => {
    setDeleteError(null);
    try {
              ...
              {hasAccess('option', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/options/create?question_id=${data?.id}`}>
                  ...
                  <TableContainer mb={4}>
                    <Table variant="simple">
                      ...
                      <Tbody>
                        {data?.option?.map((record) => (
                          <Tr
                            cursor="pointer"
                            onClick={() => router.push(`/options/view/${record.id}`)}
                            key={record.id}
                          >
                            <Td>{record.text}</Td>
                            <Td>
